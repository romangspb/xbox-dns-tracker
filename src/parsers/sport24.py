"""Парсер sport24.ru — гайд по обходу Xbox ошибки."""
...
def parse(url: str, source_id: str, today: str) -> list[Method]:
    ...
    content = soup.select_one("article") or soup.select_one(".article__content") or soup.body
    if not content:
        return []
    ...
    for i, line in enumerate(lines):
        if "xsts" in line.lower() or "роутер" in line.lower():
